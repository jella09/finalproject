    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center pt-5 min-h-screen pb-40 gap-16 font-[family-name:var(--font-geist-sans)] bg-white dark:bg-gray-900">
        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="py-2 px-2 mx-auto max-w-screen-xl lg:py-4 lg:px-4">
            <div className="mx-auto max-w-screen-sm text-center lg:mb-6 mb-4">
              <h2
                id="our-blog"
                className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white"
              >
                DASHBOARD
              </h2>
            ...
            <div className="grid gap-8 lg:grid-cols-3">
              <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-transform transform hover:scale-105 cursor-pointer">
                <h2 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white pt-3">
                  Total number of Users
                </h2>
                <h2 className="mb-2 text-4xl font-bold tracking-tight text-gray-900 dark:text-white pt-3">
                  {totalUsers}
                </h2>
              </div>
              <div className="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg transition-transform transform hover:scale-105 cursor-pointer">
      ...
      {isPopupVisible && (
        <div
          id="info-popup"
          tabIndex="-1"
          className="fixed top-0 right-0 left-0 z-50 w-full h-modal md:h-full overflow-y-auto overflow-x-hidden flex items-center justify-center"
        >
